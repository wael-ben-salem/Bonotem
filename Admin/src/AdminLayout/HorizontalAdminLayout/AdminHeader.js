            ...
            <div className="navbar-brand-box text-center">
              <Link to="/" className="logo logo-dark">
                <span className="logo-sm">
                  <img src={logoSm} alt="logo-sm-dark" height="65" />
                </span>
                <span className="logo-lg">
                  <img src={logoDark} alt="logo-dark" height="65" />
                </span>
              </Link>

              <Link to="/" className="logo logo-light">
                <span className="logo-sm">
                  <img src={logoSm} alt="logo-sm-light" height="65" />
                </span>
                <span className="logo-lg">
                  <img src={logoLight} alt="logo-light" height="65" />
                </span>
              </Link>
            </div>
